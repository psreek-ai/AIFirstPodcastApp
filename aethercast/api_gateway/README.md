...
-   **Service URLs:** URLs for backend services that CPOA calls.
    -   `TDA_SERVICE_URL`, `SCA_SERVICE_URL`, `PSWA_SERVICE_URL`, `VFA_SERVICE_URL`, `IGA_SERVICE_URL`, `AIMS_SERVICE_BASE_URL_CONTAINER`, `AIMS_TTS_SERVICE_BASE_URL_CONTAINER`.
...
-   **Purpose:** Shared table used by TDA, SCA, PSWA, IGA, and CPOA orchestration tasks to track the state of idempotent operations.
